...
| Label    | Examples                                |
|:---------|:----------------------------------------|
| positive | <ul><li>'I love this product'</li></ul> |
| negative | <ul><li>'This is terrible'</li></ul>    |
| neutral  | <ul><li>'It is okay'</li></ul>          |
